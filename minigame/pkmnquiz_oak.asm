; This is a RE-CREATION based on magazine scans,
; NOT actual recovered data!
;
...
; for a version matching the ROM, see minigame/pkmnquiz_oak_debug.asm
...
.oakIntroText
	...
	; Japanese
	lang J, text "オーキド『こ<NO>コーナーは"
	lang J, line "わし<GA>あんない　しよう！"
	...
	; English
	lang E, text "OAK: I'll guide you"
	lang E, line "through this part!"
	; this dialogue has not been recovered past this point.
	; following is filler.
	lang E, para "<……> <……>"
	lang E, line "<……> <……>"
	...
	lang D, line "dich durch diesen"
	lang D, cont "Bereich!"
	; this dialogue has not been recovered past this point.
	; following is filler.
	lang D, para "<……> <……>"
	lang D, line "<……> <……>"
	lang D, para "Fehler 2"
...
.question6Text
	...
	lang F, db   "Quel objet n'existe"
	lang F, next "pas dans les"
...
.question7Text
	...
	lang F, db   "Quel est le nombre"
	lang F, next "minimal de fois"
	lang F, next "qu'il faille parler"
	lang F, next "à CANARTICHO"
	lang F, next "pour le capturer?"
...
.question8Text
	...
	lang F, db   "Combien de" 
	lang F, next "RAMOLOSS devaient"
	lang F, next "être secourus dans"
	lang F, next "la grotte du PUITS"
	lang F, next "RAMOLOSS?"
...
.question9Text
	...
	lang F, db   "Quel est l'arrêt"
	lang F, next "de la mer lors du"
	lang F, next "tour du GUIDE de"
	lang F, next "VILLE GRIOTTE?"
...
.textScoreLow
	...
	lang F, para "Les #MANIACs"
	lang F, line "peuvent mémoriser"
	
	lang F, para "des choses dont"
	lang F, line "ils n'ont même pas"
	lang F, cont "besoin de se"
	lang F, cont "rappeler!"
	...
	lang I, para "che non hanno"
	lang I, line "nemmeno bisogno"
...
.textScoreGood
	...
	lang F, para "Est-ce que tu"
	lang F, line "vois des gens?"
	lang F, para "Il faut se faire"
	lang F, line "des amis!"
