...
; German
ELIF DEF(_LANG_D)
DEF RANKING_HEALINGS_HOF_NAME EQUS "TEAM-HEILUNGEN BEI RH." ; Max 17 chars
MACRO describe_ranking_HEALINGS_HOF
...
; German
ELIF DEF(_LANG_D)
DEF RANKING_BATTLE_TOWER_WINS_NAME EQUS "DUELLTURM" ; Max 17 chars
MACRO describe_ranking_BATTLE_TOWER_WINS
	para "Anzahl der"
	line "gewonnenen"
	cont "#MON-Kämpfe"
...
; German
ELIF DEF(_LANG_D)
DEF RANKING_HOF_ENTRIES_NAME EQUS "RUHMESHALLENEINTR." ; Max 17 chars
MACRO describe_ranking_HOF_ENTRIES
	para "Gesamtzahl der"
