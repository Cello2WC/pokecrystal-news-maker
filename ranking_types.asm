...
DEF RANKING_GAME_TIME_HOF_ADDR EQUS "sTrainerRankingGameTimeHOF"
IF DEF(_LANG_J)
DEF RANKING_GAME_TIME_HOF_NAME EQUS "?"
DEF RANKING_GAME_TIME_HOF_DESC EQUS "?"
DEF RANKING_GAME_TIME_HOF_FMT  EQUS "4, 10"
...
; 2, 5 matches. 4, 6 works
DEF RANKING_BATTLE_TOWER_WINS_FMT  EQUS "2, 5"
;DEF RANKING_BATTLE_TOWER_WINS_FMT  EQUS "4, 6"
IF DEF(_LANG_J)
...
IF DEF(_LANG_J)
DEF RANKING_LINK_WINS_NAME EQUS "コロシアムで かったかいすう"
